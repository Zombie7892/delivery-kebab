...
module.exports = function Cabinet({ login, userId, products, orders, seller }) {
  return (
    <Layout login={login} seller={seller}>
      ...
      <div className="backgroundCab">
        <div className="centerListCabinet">
          ...
          <div>
            <h3 id="marginH" className="redTextCab">
              Добавленные заказы:
            </h3>
              ...
              {orders.map((order) => (
                <div className="card" key={order.id} id="styleForCardCabinet">
                  ...
                  <div className="card-body">
                    ...
                    <h6 className="card-title">Заказчик: {order.User.login}</h6>
